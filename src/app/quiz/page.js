...
const QuizSlider = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (userAnswer.toLowerCase() === quizData[currentSlide].answer.toLowerCase()) {
      ...
      if (quizData[currentSlide].name === "invited") {
        alert(
          "Congratulations, attend this address: Bairro Vera Cruz, Rua Carlos Ribeiro 357, on January 26th at 3:30 pm"
        );
        redirect(`/`);
      }
    } else {
  ...
  return (
    <div className="min-h-screen w-full bg-black flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md mx-auto bg-black/80 rounded-lg overflow-hidden shadow-md">
        <div className="p-6 flex flex-col items-center">
          <h2 className="text-lg sm:text-xl font-bold mb-4 text-[#00ff00] text-center">
          ...
          >
            ...
            <button
              type="submit"
              className="w-full px-4 py-3 bg-white/20 backdrop-blur border-2 border-white
